package("shared.ui.view.bufferview", function(){
	
	var BufferView = Ext.extend(Ext.grid.GridView, {
		/**
		...
		initTemplates : function(){
			BufferView.superclass.initTemplates.call(this);
		...
		syncScroll: function(){
			BufferView.superclass.syncScroll.apply(this, arguments);
			this.update();
		},
	    ...
	    onRemove : function(ds, record, index, isUpdate){
	        BufferView.superclass.onRemove.apply(this, arguments);
	        if(isUpdate !== true){
	            this.update();
	        }
	    },
		...
		layout: function(){
			BufferView.superclass.layout.call(this);
			this.update();
		}
	});
