package("shared.plugins.sortablelist.dropzone", function(require){
		...
		DropZone.superclass.constructor.call(this, this.view.getEl(), { containerScroll: true, ddGroup: dd });
		this.setDroppable(ddGroup);
	};

Ext.extend(DropZone, Ext.dd.DropZone, {
	...
	getDropPoint : function(e, n, dd){
		if (n == this.view.getEl().dom) { return "below"; }
    ...
    onNodeDrop : function(n, dd, e, data){
        if (this.view.fireEvent("drop", this, n, dd, e, data) === false) {
            return false;
        }
        ...
        var insertAt = (this.view.appendOnly || (n == this.view.getEl().dom)) ? this.view.store.getCount() : this.view.indexOf(n);
        if (pt == "below") {
            insertAt++;
        }
