...
Ext.layout.CardLayout = Ext.extend(Ext.layout.FitLayout, {
    ...
    setActiveItem : function(item){
        ...
        if(ai != item){
            ...
            if (this.transitionConfig && this.transitionConfig.anim && this.transitionConfig.anim.isAnimated){
				this.transitionConfig.anim.stop(true);
			}

			 this.transitionConfig = Ext.apply({ duration:0.2 }, this.transitionConfig || {});
			
            
            item.el.show(this.transitionConfig)
            this.layout();
            if(item && layout){
                item.doLayout();
            }
